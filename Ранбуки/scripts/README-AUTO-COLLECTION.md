...
2. **Скопируйте результаты в соответствующие разделы КБ:**
   - `Сервисы/1c/platform-8.3.md` — информация о платформе 8.3
   - `Сервисы/1c/platform-8.5.md` — информация о платформе 8.5
   - `Сервисы/mssql/server-2019.md` — информация о SQL Server 2019
...
- [PVD-1C Server](../../Инфраструктура/servers/pvd-1c.md)
- [PVD-SQL Server](../../Инфраструктура/servers/win-dckio4rlmnm.md)
- [Zabbix Monitoring](../../Сервисы/monitoring/zabbix-server.md)
