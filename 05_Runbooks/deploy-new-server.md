...
related: ["02_Infrastructure/servers/template-server.md", "04_Access/users-roles.md"]
...
- [ ] Создать запись в IP allocation файле: [02_Infrastructure/network/ip-allocation.md](../../02_Infrastructure/network/ip-allocation.md)
...
- [ ] Добавить в [02_Infrastructure/servers/](../../02_Infrastructure/servers/)
