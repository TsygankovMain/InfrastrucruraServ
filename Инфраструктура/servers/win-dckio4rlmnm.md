...
### Documentation
- [MSSQL Server 2019 Service Guide](../Сервисы/mssql/server-2019.md)
- [1C Enterprise Application Server (PVD-1C)](pvd-1c.md)
- [Network Firewall Rules](../Инфраструктура/network/firewall-rules.md)
- [Backup Policy](../Инфраструктура/storage/backup-policy.md)

### Runbooks
- [MSSQL Database Recovery Procedures](../../Ранбуки/mssql-recovery.md)
- [Transaction Log Growth Management](../../Ранбуки/txn-log-management.md)
- [MSSQL Failover Procedures](../../Ранбуки/mssql-failover.md)
